...
export default function TodayPage() {
  ...
  return (
    ...
    <div className="mx-auto flex max-w-[1280px] flex-col gap-5">
      ...
      {/* Follow-ups drawer was REMOVED 2026-05-08 (Ethan): 🔁-tagged
          Notion tasks now live inline in the Tasks list with the same
          bucketing logic as regular tasks (only difference: they have
          a due date). Phone callbacks remain accessible via the
          "Follow-ups due" stat card and the /follow-ups page link. */}
