...
/**
 * GET    /api/team/eod-reports/[id]  → own report
 * PATCH  /api/team/eod-reports/[id]  → edit any field on own report
 * DELETE /api/team/eod-reports/[id]  → remove own report
 *
 * Mirrors /api/agent/eod-reports/[id] with a team_member role gate.
 * Ownership enforced via (id, agentUserId) in the where clause.
 */
